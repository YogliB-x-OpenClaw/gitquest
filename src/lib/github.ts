...
export const POPULAR_REPOS: PopularRepo[] = [
  ...
  },
  {
    owner: "microsoft",
    repo: "vscode",
    desc: "Visual Studio Code — open source code editor",
    stars: "165k",
    lang: "TypeScript",
  },
  ...
  },
  {
    owner: "kubernetes",
    repo: "kubernetes",
    desc: "Production-Grade Container Scheduling",
    stars: "111k",
    lang: "Go",
  },
  {
  ...
  },
  {
    owner: "ollama",
    repo: "ollama",
    desc: "Get up and running with large language models",
    stars: "98k",
    lang: "Go",
  },
];
...
export function analyzeCommits(commits: Commit[]): Analysis {
  ...
  const refactorCount = commits.filter((c) =>
    /refactor|clean|improve|update/i.test(c.subject),
  ).length;
